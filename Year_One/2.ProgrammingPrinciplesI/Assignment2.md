# Assignment Two - Selections #1

[<< Go back up a level](ProgrammingPrinciplesI.md)

## Assignment Overview

Assignment 2 - Selections #1

Write a java program which does the following:
	•	Makes user enter a name
	•	Makes them enter an age
	•	If they are over 40, print their name follow by "you are very old!"
