...
Statistics Program
Due Nov 21 by 11:59pm 
Points 50 
Submitting a file upload 
File Types zip 

You will write a statistics program which will maintain a list of double values and produce statistics from those values. Your program will implement the following menu:
1.) Add Value to List
...
10.) Save List of Numbers to File
11.) Read List of Numbers from File
 
0.) Exit
 
This menu should NOT be changed.
The statistics functions have been created in an earlier assignment.   You should write a separate method for each of the menu options that takes your value list (array) as a parameter.
All array maintenance operations (#1, #2, #3 and #4 from menu) should use method from your ArrayUtils class. Options #10 and #11 should use your FileUtils class.  You may NOT use the java Array, Collections and/or Arrays class.  
