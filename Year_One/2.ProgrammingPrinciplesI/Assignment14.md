# Assignment 14 - RegularPolygon

[<< Go back up a level](ProgrammingPrinciplesI.md)

## Assignment Overview

Regular Polygon class creation
Due Nov 19 by 11:59pm 
Points 100 
Submitting a file upload 
File Types zip and jar 

You will create a class that will then be instanced to create Regular Polygons.  Regular Polygons are equilateral/equiangular polygons of a specified number of sides and side lengths.  Squares, pentagons, hexagons and octagons are all examples of regular polygons.
An javadoc api  will be provided, as will a RegularPolygonTester.java   file you can use to insure your classes are working correctly.
You will create the following 3 files:
	1	RegularPolygon.java - Defines a regular polygon
	2	PerimeterSort.java - A Comparator implementation defining a perimeter sort
	3	AreaSort.java - A Comparator implementation defining an area sort.
Any formulas needed are included in the javadoc api.  Your classes should adhere to these perfectly.
You will submit either a zip or jar file here including your 3 java files.

RegularPolygon: DVC
RegularPolygon: EVC (double pSideLength)
RegularPolygon: EVC (int pSides)
RegularPolygon: EVC (int pSides, double pSideLength)
RegularPolygon: getSideLength(), getSides()
RegularPolygon: setSideLength(), setSides()
RegularPolygon: toString
RegularPolygon: getPerimeter
RegularPolygon: getApothem()
RegularPolygon: getArea()
RegularPolygon: implements Comparable and compareTo()
RegularPolygon: implements Comparator and correct compare()
AreaSort: implements Comparator and correct compare()
