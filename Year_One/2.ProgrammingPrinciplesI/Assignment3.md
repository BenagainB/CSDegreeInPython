# Assignment Three - Selections #2

[<< Go back up a level](ProgrammingPrinciplesI.md)

## Assignment Overview

Assignment 3 - Selections #2

Write a java program which does the following:
	•	Have the user input their name:
	•	Have the user input their weight:
	◦	If they are over 200lbs, display their name with the statement "time to think about a diet"
	◦	If they are under 100lbs, print their name with the statement: "time to hit the buffet"
	◦	If neither, print their name with the statement: "nothing to see here, carry on."
You must use a single if block.
