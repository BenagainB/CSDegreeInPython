# Assignment Five - Loops #1

[<< Go back up a level](ProgrammingPrinciplesI.md)

## Assignment Overview

Assignment 5 - Loops #1

You will write a java program to do the following using count controlled for loops :
	•	Print the numbers from 0 to 10
	•	Print a blank line
	•	Print the numbers from 10 to 20 by 3's (10, 13, et. al.)
	•	Print a blank line
	•	Print the numbers from 20 to 10 by 2's (20,18, et. al.)
	•	Print a blank line
	•	Print the numbers 1 to 100 that are evenly divisible by 11.
