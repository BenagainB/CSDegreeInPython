# Assignment Four - Selections #3

[<< Go back up a level](ProgrammingPrinciplesI.md)

## Assignment Overview

Assignment 4 - Selections #3

Write a java program which will do the following:
	•	Ask the user to input a color
	•	If the color is Blue, Red or Yellow, print the color with the statement "is a primary color."
	•	If the color is Purple, Orange or Green, print the color with the statement "is a secondary color"
	•	If the color is Brown, print the color with the statement "is a tertiary color"
	•	If none of these, print the color with the statement: "I'm not sure how to make this" on one line and  "but it's a lovely color." on the next line.
This must be done with a single if statement block.
